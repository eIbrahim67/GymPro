...
class MyTrainingPlansFragment : Fragment() {
    ...
    private val viewModel: MyTrainingPlansViewModel by viewModels {
        ...
        MyTrainingPlansViewModelFactory(app.remoteRepository, app.userRepository)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapterRVMyFeaturedPlans =
            AdapterRVMyFeaturedPlans({ id -> goToTrainPlan(id) }, { id -> deleteTrainPlan(id) })
