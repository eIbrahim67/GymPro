...
class AdapterRVFeaturedPlans(
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView.context).load(item.imageUrl).centerCrop()
    ...
    private val differ: AsyncListDiffer<TrainPlan> = AsyncListDiffer(this, DIFF_CALLBACK)
    ...
    companion object {
        val DIFF_CALLBACK = object : DiffUtil.ItemCallback<TrainPlan>() {
            override fun areItemsTheSame(
                oldItem: TrainPlan, newItem: TrainPlan
