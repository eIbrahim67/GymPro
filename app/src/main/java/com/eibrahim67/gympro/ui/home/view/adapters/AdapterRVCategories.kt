...
class AdapterRVCategories(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_rv_categories, parent, false)
        parent.context
    ...
    private val differ: AsyncListDiffer<Category> = AsyncListDiffer(this, DIFF_CALLBACK)
