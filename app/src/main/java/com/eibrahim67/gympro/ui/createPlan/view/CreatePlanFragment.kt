package com.eibrahim67.gympro.ui.createPlan.view
...
import com.eibrahim67.gympro.ui.createPlan.viewModel.CreatePlanViewModel
import com.eibrahim67.gympro.ui.createPlan.viewModel.CreatePlanViewModelFactory
...
class CreatePlanFragment : Fragment() {
    ...
    private val viewModel: CreatePlanViewModel by viewModels {
        ...
        CreatePlanViewModelFactory(app.remoteRepository, app.userRepository)
    }
