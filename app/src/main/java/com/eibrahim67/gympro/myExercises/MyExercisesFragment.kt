...
class MyExercisesFragment : Fragment() {
    ...
    private val viewModel: MyExercisesViewModel by viewModels{
        ...
        MyExercisesViewModelFactory(remoteRepository, userRepository)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapterMyExercises = AdapterMyExercises ({ id -> goToExercise(id) }, {id -> deleteExercise(id)})
        ...
        viewModel.loggedInUser.observe(viewLifecycleOwner) { user ->
            ...
            when (user) {
                ...
                is ResponseEI.Success -> {
                    ...
                    user.data?.let { viewModel.getMyExercisesIds(it.id) }
